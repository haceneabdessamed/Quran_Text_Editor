...
$CONF['sphinx_port'] = 9300; //this demo uses the SphinxAPI interface

$CONF['mysql_host'] = "localhost";
$CONF['mysql_username'] = "root";
$CONF['mysql_password'] = "";
$CONF['mysql_database'] = "quran";

$CONF['sphinx_index'] = "test1"; // can also be a list of indexes, "main, delta"
...
if (!empty($_GET['q'])) require 'C:\sphinx\api\sphinxapi.php';
